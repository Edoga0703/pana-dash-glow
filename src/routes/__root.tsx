...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pana Bot — Admin Dashboard" },
      { property: "og:description", content: "Gestión de inventario, chats y logs del bot de WhatsApp de CuentasTupana." },
